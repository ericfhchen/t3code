...
/**
 * The palette CODE wears with no theme installed, captured from the app's
...
/**
 * The standard CODE look as a theme palette, for seeding a new theme when
...
/**
 * The status colors CODE shows without a theme, read from the app's own
