    ...
    widgets: [
      {
        ...
        description: "Subscription quotas from your connected CODE environments.",
        configuration: {
      ...
      },
      {
        ...
        description: "Shows the current state of active CODE agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow CODE to connect to CODE servers on your local network or tailnet.",
      NSPhotoLibraryAddUsageDescription: "Allow CODE to save images to your photo library.",
  ...
  plugins: [
    ...
    [
      "expo-audio",
      {
        microphonePermission: "Allow CODE to use your microphone for voice input.",
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow CODE to access your camera so you can scan pairing QR codes.",
