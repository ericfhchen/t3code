...
export const tweets = [
  ...
  },
  {
    ...
    content: "I would just use CODE at that point and contribute back.",
  ...
  },
  {
    ...
    content:
      "Well I was 2,000 miles away on holiday and able to do iOS development from just my phone, CODE’s remote feature is a magical experience",
  ...
  },
  {
    handle: "aronprins",
    content:
      "CODE works better than Claude and Codex combined… and T3 actually combines then (and more!) 🤯\n\nHuge shoutout to @theo and @jullerino\n\nAmazing product fellers 🔥🙌",
    excerpt:
      "CODE works better than Claude and Codex combined… and T3 actually combines then (and more!)",
  ...
  },
  {
    handle: "teja2495",
    content:
      "I’ve completely switched to CODE for all my workflows. I just switch between different subscriptions and harnesses depending on what I need.",
    excerpt: "I’ve completely switched to CODE for all my workflows.",
    link: "https://x.com/teja2495/status/2052420254991581623",
  },
  {
    handle: "ryanrhughes",
    content:
      "Then there's the mobile app. All of my threads, on all of my environments, in my pocket. Fantastic.\n\nWhile traveling the other day, I had to use CODE alongside my old Claude Code + Herdr setup from 36,000ft on my phone.\n\nOn CODE, it felt like LAN. On the TUI, every keystroke took about 1sec to show up because it had to roundtrip to the device before I was able to actually see it. Brutal.",
    excerpt: "...from 36,000ft on my phone. On CODE, it felt like LAN.",
    link: "https://x.com/ryanrhughes/status/2093051708939059204",
  },
  {
    handle: "ex0t1clol",
    content: "CODE is proof electron apps don't have to suck",
    link: "https://x.com/ex0t1clol/status/2054666870008021197",
  },
  {
    handle: "enunomaduro",
    content: "So I tried @theo's CODE...",
    link: "https://x.com/enunomaduro/status/2091915930141876495",
  },
  {
    handle: "pocarles",
    content:
      "Only using Codex and T3 now.\n\nI thought all AI coding harnesses had roughly the same impact. Using CODE taught me how wrong I was. The interface between you and the model changes everything.",
    excerpt:
      "Using CODE taught me how wrong I was. The interface between you and the model changes everything.",
    link: "https://x.com/pocarles/status/2054673964274758046",
  },
  {
    handle: "BennettBuhner",
    content:
      "CODE is literally Codex but better; all your favorite models and harnesses, accessible anywhere! The app is great but the website is even greater, so instead of needing to SSH into a machine, T3 IS my SSH!",
    excerpt:
      "CODE is literally Codex but better; all your favorite models and harnesses, accessible anywhere.",
    link: "https://x.com/BennettBuhner/status/2054667115697754387",
  },
  {
    handle: "leodev",
    content:
      "CODE is probably the first coding gui that didn't suck performance wise and had a smart team behind it.",
  ...
  },
  {
    ...
    content: "Heartbreaking: AI-hater has to admit CODE is really good.",
    link: "https://x.com/_winter_wonders/status/2052350198764970434",
  },
  {
    handle: "kostyniuk00",
    content:
      "I was not expecting a year ago, that my anti-AI colleagues would thank me a year later, for persuading them to try CODE Beta, that really helped them with organizing their workflows. \n\nFantastic product by @jullerino and @theo. Go try it out if you haven’t yet!",
    excerpt:
      "My anti-AI colleagues thanked me for persuading them to try CODE Beta. Fantastic product.",
