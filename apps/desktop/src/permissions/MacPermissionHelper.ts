...
<header>↑ Drag CODE into the list above</header>
<button id="app" draggable="true" aria-label="Drag CODE to System Settings, or click to reveal in Finder"><img src="${escapeHtml(icon)}" alt="" draggable="false">CODE</button>
</main></body></html>`;
}
...
export class MacPermissionHelper {
  ...
  async show(
    ...
    if (!appIcon) throw new Error("The packaged CODE icon is missing.");
